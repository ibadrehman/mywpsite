...
// Register widget areas. For showing the slider
...
/*
 * Add in Home Widget Areas (below that slider)
 */
...
function my_credits() {
	return 'Copyright [footer_copyright]  <a href="http://cloudways.com/">Cloudways.</a>';
}
